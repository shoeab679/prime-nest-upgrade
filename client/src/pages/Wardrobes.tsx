...
export default function Wardrobes() {
  const features = [
    ...
    'Mirror panels for enhanced aesthetics',
    'Soft-close sliding or hinged doors',
    'Organized compartments and drawers',
  ...
  const types = [
    { name: 'Sliding Door Wardrobes', desc: 'Space-saving design perfect for compact bedrooms' },
    { name: 'Hinged Door Wardrobes', desc: 'Classic design with full access to storage' },
    { name: 'Walk-in Wardrobes', desc: 'Luxury option for larger master bedrooms' },
    { name: 'Modular Wardrobes', desc: 'Flexible design that grows with your needs' },
  ];
  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative h-96 md:h-screen min-h-[500px] flex items-center justify-center overflow-hidden">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Premium Wardrobe Designs</h1>
          <p className="text-lg md:text-xl text-gray-100">
            Elegant wardrobes that combine style, functionality, and optimal organization
          </p>
        </motion.div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container max-w-4xl">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-dark-accent mb-6">Why Choose Our Wardrobes?</h2>
            <p className="text-lg text-gray-700">
              Our custom-designed wardrobes maximize storage while adding elegance to your bedroom. Each wardrobe is tailored to your space and style preferences.
            </p>
          </motion.div>
      ...
      <section className="py-16 md:py-24 bg-soft-gray">
        <div className="container">
          <motion.div
            ...
            className="text-center mb-12 md:mb-16"
          >
            <h2 className="text-3xl md:text-4xl font-bold text-dark-accent mb-4">Wardrobe Types</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {types.map((type, index) => (
              ...
              >
                <h3 className="text-2xl font-bold text-dark-accent mb-3">{type.name}</h3>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container">
          <motion.div
            ...
            className="text-center mb-12 md:mb-16"
          >
            <h2 className="text-3xl md:text-4xl font-bold text-dark-accent mb-4">Smart Storage Solutions</h2>
            <div className="w-16 h-1 bg-gold mx-auto"></div>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                title: 'Compartments',
                items: ['Hanging rails', 'Shelves', 'Drawers', 'Shoe racks']
              },
              {
                title: 'Features',
                items: ['Mirror panels', 'LED lighting', 'Soft-close doors', 'Jewelry trays']
              },
              {
                title: 'Finishes',
                items: ['Matte', 'Glossy', 'Wood grain', 'Textured']
              },
            ].map((category, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-16 md:py-24 bg-soft-gray">
        <div className="container">
          <motion.div
            ...
            className="text-center mb-12 md:mb-16"
          >
            <h2 className="text-3xl md:text-4xl font-bold text-dark-accent mb-4">Featured Wardrobes</h2>
            <div className="w-16 h-1 bg-gold mx-auto"></div>
          </motion.div>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container max-w-3xl">
          ...
          <div className="space-y-6">
            {[
              { step: '1', title: 'Space Assessment', desc: 'We measure and assess your bedroom space' },
              { step: '2', title: 'Design Consultation', desc: 'Discuss your storage needs and style preferences' },
              { step: '3', title: '3D Visualization', desc: 'Create detailed 3D renderings of your wardrobe' },
              { step: '4', title: 'Installation', desc: 'Professional installation with precision and care' },
              { step: '5', title: 'Quality Assurance', desc: 'Final inspection and warranty documentation' },
            ].map((item, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, x: -20 }}
      ...
      <section className="py-16 md:py-24 bg-dark-accent text-white">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Upgrade Your Bedroom?</h2>
          <p className="text-lg text-gray-300 mb-8">
            Book a free consultation with our wardrobe design experts and get a personalized proposal
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="https://wa.me/919542663490?text=Hi%20Prime%20Nest%20Interiors,%20I%20would%20like%20to%20book%20a%20free%20consultation%20for%20wardrobe%20design"
              target="_blank"
